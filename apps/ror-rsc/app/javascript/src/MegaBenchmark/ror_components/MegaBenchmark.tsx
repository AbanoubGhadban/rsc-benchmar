...
const MegaBenchmark = ({ timestamp, getReactOnRailsAsyncProp }: PropsType) => {
  ...
  return (
    <main>
      <h1>MEGA React on Rails Pro Dashboard - {timestamp}</h1>
      <p>ALL DATA: 500 users, 1000 posts, 5000 comments with async props streaming</p>
