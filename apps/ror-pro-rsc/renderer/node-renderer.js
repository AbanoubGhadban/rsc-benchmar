...
const config = {
  ...
  workersCount: configuredWorkersCount ?? 1,  // Use 1 worker
  ...
  // Including require is necessary for webpack externals (async_hooks, crypto, etc.)
  additionalContext: { URL, AbortController, require },
